...
Note: A batch job is a computer program that executes a (often huge) 
sequence of commands. For example, processing all the orders that were
made in a day.
```
...
![](/assets/img/chapter6/exercises/tdd_skeleton.svg)
...
{% include exercise-begin.html %}
Now we have a (poorly drawn) skeleton for the testing pyramid.
What words/sentences should be at the numbers?

![](/assets/img/chapter6/exercises/pyramid_skeleton.svg)
